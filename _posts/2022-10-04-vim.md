...
subtitle: Configurando temas, extensiones y atajos para el editor Vim. 
cover-img: /assets/img/PortadasEditadas/vim.png
thumbnail-img: /assets/img/logos/vim.png
share-img: /assets/img/PortadasEditadas/vim.png
tags: [vim, shell, ide]
---
